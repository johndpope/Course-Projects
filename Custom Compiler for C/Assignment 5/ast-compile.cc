...
Code_For_Ast & Selection_Statement_Ast::compile(){
	...
	Control_Flow_IC_Stmt * ctrl_stmt0 = new Control_Flow_IC_Stmt(beq, cond_reg_opd, l0);
	...
	{	
		...
		Control_Flow_IC_Stmt * ctrl_stmt1 = new Control_Flow_IC_Stmt(j, NULL, l1);
...
Code_For_Ast & Iteration_Statement_Ast::compile(){
	...
	Register_Addr_Opd * cond_reg_opd = new Register_Addr_Opd(cond_stmt.get_reg());
	Control_Flow_IC_Stmt * ctrl_stmt0 = new Control_Flow_IC_Stmt(bne, cond_reg_opd, l0);
