...
%token VOID INTEGER FLOAT ASSIGN DO WHILE IF ELSE PRINT
%right ASSIGN
%right '?'
%left OR 
%left AND 
...
%type<ast> assignment_statement print_statement expression variable constant conditional_statement then_statement condition single_condition
%%
...
constant:	NUM
			...
			;
//  scp /mnt/c/Users/Lenovo/Documents/Lab5_base/* sarthak@sl2-15.cse.iitb.ac.in:~/Downloads/Lab5